...
.untreated .search span {
  color: #fff;
  font-size: 14px;
}
.untreated .search button {
  color: #fff;
  border-radius: 15%;
...
.untreated .content .info .time div:nth-child(1) {
  flex: 60%;
  display: flex;
  justify-content: space-between;
}
.untreated .content .info .time div:nth-child(2) {
  flex: 40%;
  text-align: right;
}

.untreated .content .info .time .go {
